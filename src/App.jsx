...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* 1. WebGL Prism Background Matrix */}
      ...
      {/* 3. Centered Layout Typography Content Canvas Frame */}
      <main style={{
        position: 'absolute',
        inset: 0,
        zIndex: 20,
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* 3. React Bits Fluid Glass Refraction Interaction Layer (Top Overlay) */}
