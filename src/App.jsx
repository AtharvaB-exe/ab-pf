...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* 1. WebGL Prism Shader Background Layer (Base Bottom) */}
      ...
      {/* 2. Centered Layout Typography Content Canvas Frame (Middle Layer) */}
      <main style={{
        position: 'absolute',
        inset: 0,
        zIndex: 10,
      ...
      {/* 3. React Bits Fluid Glass Overlay Layer (Top Refraction Over EVERYTHING) */}
